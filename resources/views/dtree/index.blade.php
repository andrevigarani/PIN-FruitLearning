...
@section('content')
    <div class="d-flex flex-column justify-content-center align-items-center text-white" style="height: 80vh;">
        <h1>Insira o arquivo para ser classificado pelo algoritmo de árvore de decisão:</h1>
        <form id="uploadForm" action="{{ route('decision-tree.upload') }}" method="POST" enctype="multipart/form-data" class="mt-4">
            @csrf
